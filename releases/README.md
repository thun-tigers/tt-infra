...
- `releases/0.1.5.env` pinnt den Beta-Stack auf `v0.1.5`
...
- wenn Arcane nur eine Env-Datei akzeptiert, die Basis-Env mit dem Manifest vorab mergen, zum Beispiel mit `python scripts/render_arcane_env.py --base .env.arcane.beta --overlay releases/0.1.5.env --output .env.arcane.beta.v0.1.5`
